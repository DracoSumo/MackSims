# Career package — Christopher Sims

Files for job applications (remote + Tampa/Florida area, any work arrangement):

| File | Use |
| --- | --- |
| `Christopher_Sims_Resume.pdf` | Attach to applications and emails |

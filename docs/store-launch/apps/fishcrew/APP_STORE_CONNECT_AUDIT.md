# FishCrew - App Store Connect Audit
...
FishCrew is treated as an existing App Store Connect record. Do not create a duplicate app record, change the bundle ID, or create a second listing without explicit owner approval.
...
| App name confirmed? | READY | Locally documented as FishCrew; verify exact App Store Connect display before submit |
...
| Age rating started? | NEEDS OWNER CONFIRMATION | Must reflect UGC, location, messaging, and any web content |
...
| Build uploaded? | NEEDS OWNER CONFIRMATION | Prior docs reference FishCrew wrapper commit `f795bc3`; console upload not locally visible |
...
- Do not imply that every charter, captain, or local water feature is live unless present in the submitted build.

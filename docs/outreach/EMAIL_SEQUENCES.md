...
### Touch 2
**Subject:** Re: ShutterBid beta

Following up — if ShutterBid isn’t useful, no worries. If it is, I can walk you through listing a profile in 10 minutes.
...
### Touch 2
**Subject:** Re: FishCrew for [Business]

Quick bump — even a “not for us” reply helps. If you want, I’ll show the charter flow on a shared screen this week.
...
Scripts expect: `business_name`, `contact_name`, `email`, `vertical`, `product`, `city`, `website`

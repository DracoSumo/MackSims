...
const TRANSLATIONS = [
  { id: 'KJV', name: 'King James Version (KJV)', license: 'Public Domain' },
  { id: 'ESV', name: 'English Standard Version (ESV)', license: 'Licensed – Crossway' },
  { id: 'NIV', name: 'New International Version (NIV)', license: 'Licensed – Biblica' },
  { id: 'NKJV', name: 'New King James Version (NKJV)', license: 'Licensed – Thomas Nelson' },
  { id: 'CSB', name: 'Christian Standard Bible (CSB)', license: 'Licensed – Holman' },
]
...
const FALLBACK_VERSES: Verse[] = [
  { ref: 'John 3:16', text: { KJV: 'For God so loved the world, that he gave his only begotten Son...', ESV:'For God so loved the world, that he gave his only Son...', NIV:'For God so loved the world that he gave his one and only Son...', NKJV:'For God so loved the world that He gave His only begotten Son...', CSB:'For God loved the world in this way: He gave his one and only Son...' }, themes: ['salvation','love','gospel'] },
  ...
  { ref: 'Matthew 28:19-20', text: { KJV: 'Go ye therefore, and teach all nations, baptizing them...', ESV:'Go therefore and make disciples of all nations, baptizing them...', NIV:'Therefore go and make disciples of all nations, baptizing them...', NKJV:'Go therefore and make disciples of all the nations, baptizing them...', CSB:'Go, therefore, and make disciples of all nations, baptizing them...' }, themes: ['mission','discipleship','great commission'] },
  { ref: 'Romans 12:2', text: { KJV: 'Be not conformed to this world: but be ye transformed by the renewing of your mind...', ESV:'Do not be conformed to this world, but be transformed by the renewal of your mind...', NIV:'Do not conform to the pattern of this world, but be transformed by the renewing of your mind...', NKJV:'Do not be conformed to this world, but be transformed by the renewing of your mind...', CSB:'Do not be conformed to this age, but be transformed by the renewing of your mind...' }, themes: ['transformation','holiness','mind'] },
]
...
function buildSermonNotes(sermon: Sermon, songs: Song[], seriesList: Series[]): string {
  ...
  if (sermon.passages.length) {
    lines.push('', 'Passages:')
    sermon.passages.forEach(p => lines.push(`- ${p}`))
  }
...
export default function Page() {
  ...
  async function copySermonNotes() {
    const text = buildSermonNotes(sermon, songs, series)
    try {
      ...
      <div className='space-y-4'>
        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            ...
            <p className='text-xs text-gray-500'>Licensing note: Some translations require publisher licenses for on-screen or printed use. Configure per-translation rights in settings.</p>
          </CardContent>
        </Card>
        )}

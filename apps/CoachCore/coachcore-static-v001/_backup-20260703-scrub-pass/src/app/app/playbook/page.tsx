...
export default function PlaybookPage() {
  return (
    ...
    >
      <div className="mb-6 flex flex-wrap gap-3"><a href="/app/playbook/new" className="rounded-2xl bg-sky-400 px-5 py-3 font-black text-slate-950">Create Mock Playbook Item</a></div><div className="mb-6 flex flex-wrap gap-3"><a href="/app/playbook/new" className="rounded-2xl bg-sky-400 px-5 py-3 font-black text-slate-950">Create Mock Playbook Item</a></div><div className="grid gap-4 md:grid-cols-2">

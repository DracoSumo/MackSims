...
export default function Home() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.28),_transparent_35%),linear-gradient(135deg,#020617,#0f172a_50%,#020617)] text-white">
      <section className="mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-8">
        <header className="flex items-center justify-between">
          ...
          <Link
            href="/app"
            className="rounded-full border border-sky-300/40 px-5 py-2 text-sm font-semibold text-sky-100 hover:bg-sky-300/10"
          >
            Sign In
          </Link>
        </header>
        ...
        <div className="grid flex-1 items-center gap-10 py-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/beta"
                className="rounded-full bg-sky-400 px-6 py-3 font-bold text-slate-950 shadow-lg shadow-sky-500/20 hover:bg-sky-300"
              >
                Start Demo
              </Link>
              <Link

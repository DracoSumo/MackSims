...
export function MetricCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-[12px] border border-[rgba(248,231,201,0.14)] bg-[linear-gradient(180deg,rgba(12,48,68,0.92),rgba(6,25,39,0.94))] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.34)]">
...
export function CommandCard({
  ...
  return (
    <Link
      href={href}
      className="group relative block overflow-hidden rounded-[12px] border border-[rgba(248,231,201,0.14)] bg-[linear-gradient(180deg,rgba(12,48,68,0.92),rgba(6,25,39,0.94))] p-6 shadow-[0_12px_34px_rgba(0,0,0,0.22)] transition hover:-translate-y-0.5 hover:border-teal-300/35"
    >
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),transparent_36%)]" />

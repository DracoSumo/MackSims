...
export function CoachOnboardingCard() {
  ...
  return (
    <div className="mt-6 rounded-[2rem] border border-sky-300/25 bg-sky-300/10 p-6">
      ...
      <h2 className="mt-3 text-2xl font-black">What does &ldquo;locked in&rdquo; mean?</h2>
      <p className="mt-3 max-w-2xl text-sm leading-6 text-sky-50/90">{coachCoreConfig.accountabilityDefinition}</p>

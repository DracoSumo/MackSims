...
export default function SignupPage() {
  return (
    <AuthShell
      ...
      description="Create a coach, athlete, gym, school, club, or performance facility profile. Supabase OAuth is ready once provider credentials are enabled."
    >
      <div>
        <h2 className="text-3xl font-black">Create demo workspace</h2>
        <p className="mt-2 text-sm text-slate-400">
          Signup stores locally in demo mode. Real accounts use Supabase OAuth once Google or GitHub is enabled.
        </p>
        ...
        <div className="mt-6 space-y-4 opacity-70">
          <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Profile fields — later onboarding step</p>

/**
 * CoachCore community safety — local-first with optional Supabase sync.
 * Reporter identity is never written into shared UI state.
 */
...
export type ContentReport = {
  ...
  status: ReportStatus;
  createdAt: string;
  /** Local-only; never render to other users. */
  reporterKey?: string;
...
const BLOCKS_KEY = "coachcore.blockedUsers.v1";
const REPORTS_KEY = "coachcore.contentReports.v1";

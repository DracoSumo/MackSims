...
import { APP_NAME, BETA_LABEL, FEEDBACK_EMAIL, VERSION_LABEL } from "../config";
    ...
    <div className="beta-gate">
      <div className="beta-gate-card">
        ...
        <p className="beta-gate-lead">
          FairShare compares taxis, rideshare-style services, shuttles, private drivers, walking, and
          designated-driver options — with nightlife context and CrowdMeter pickup pressure.
        </p>
        ...
        <div className="beta-gate-disclaimer">
          ...
          <ul>
            ...
            <li>
              ...
              <a href={`mailto:${FEEDBACK_EMAIL}?subject=FairShare%20Beta%20Feedback`}>{FEEDBACK_EMAIL}</a>.
            </li>
          </ul>
        </div>
